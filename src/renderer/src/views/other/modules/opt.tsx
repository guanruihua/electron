...
export default function Opt() {
  const Conf: {
  ...
  }[] = [
    {
      title: 'System',
      children: [
        ['最大化', () => window.api.invoke('window-maximize')],
        ['取消最大化', () => window.api.invoke('window-unmaximize')],
        ['最小化', () => window.api.invoke('window-minimize')],
        ['关闭 ', () => window.api.invoke('window-close'), 'close'],
        ['打开遮罩', () => window.api.openMaskWindow()],
        ['Devtool', () => window.api.invoke('toggleDevTools')],
        ['Reload', () => window.location.reload(), 'reload'],
      ],
    },
    {
      title: 'Nginx',
